...
= 1.4.0 - 26/01/2021 =
- Added: Notice if there’s no category found
- Few minor bug fix and improvements

= 1.3.10 - 03/01/2021 =
- Fixed: Links not working on iPhone devices when Instant Answer is enabled
- Fixed: Missing Table of Contents option on smaller devices for single docs Layout 2 & 3
- Few minor bug fix and improvements
...
- Added: Shortcode to display Multiple Knowledge-base
- Fixed: Incompatibility issues with BuddyBoss theme
- Fixed: Sub-categories not displaying for Multiple KB
- Fixed: PHP Notices with Role Management
- Few minor bug fix and improvements
...
= 1.2.7 - 15/04/2020 =
- Fixed : Nested category styling issue

= 1.2.6 - 06/04/2020 =
- New Shortcode : Add Option to show a certain category
...
= 1.1.6 - 22/12/2019 =
- Fixed : New post display issue according to category
- Fixed : Post count issue
- Fixed : Docs page layout 3 space between content styling issue

= 1.1.5 - 19/12/2019 =
- Fixed : Active URL issue for Getting Started
- Improved : Sidebar styling options
...
- Added : Automatic category assigning when creating new article
- Added : Copy snippet option for cross domain snippet
- Added : Reactions on single docs
- Improved : Analytics
- Few minor bugfix and improvements
...
- Improved : Instant Answer styling and typography
