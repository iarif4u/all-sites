 ...
 * @since      1.0.0
 */
class standard_pro_Random_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-standard_pro-random widget_posts_thumbnail',
			'description' => __( 'Display random posts with thumbnails.', 'standard-pro' )
		);

		// Create the widget.
		parent::__construct(
			'standard_pro-random',                                   // $this->id_base
			__( '&raquo; Random Posts', 'standard-pro' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Random Posts', 'standard-pro' ),
			'limit'     => 5,
			'show_date' => true
		);
