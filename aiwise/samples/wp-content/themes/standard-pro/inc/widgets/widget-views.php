 ...
 * @since      1.0.0
 */
class standard_pro_Views_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-standard_pro-views widget_posts_thumbnail',
			'description' => __( 'Display the most viewed posts with thumbnails.', 'standard-pro' )
		);

		// Create the widget.
		parent::__construct(
			'standard_pro-views',                                        // $this->id_base
			__( '&raquo; Most Viewed Posts', 'standard-pro' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Most Viewed Posts', 'standard-pro' ),
			'limit'     => 5,
			'show_date' => true
		);
