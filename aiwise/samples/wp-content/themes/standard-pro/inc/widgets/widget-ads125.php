 ...
 * @since      1.0.0
 */
class standard_pro_Ads125_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-standard_pro-ad125 widget_125',
			'description' => __( 'Display 125x125 ads.', 'standard-pro' )
		);

		// Create the widget.
		parent::__construct(
			'standard_pro-ad125',                                  // $this->id_base
			__( '&raquo; Advertisement 125x125', 'standard-pro' ), // $this->name
	...
	public function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'    => esc_html__( 'Advertisement', 'standard-pro' ),
			'ad_code1' => '',
			'ad_code2' => '',
			'ad_code3' => '',
			'ad_code4' => '',
