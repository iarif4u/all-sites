...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'standard_pro Fonts', 'standard-pro' ) ) ) );
	$standard_pro_fonts = customizer_library_get_standard_pro_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'standard-pro' ) ) ) );
	 ...
	 */
	return apply_filters( 'customizer_library_all_fonts', array_merge( $heading1, $standard_pro_fonts, $heading2, $google_fonts ) );
}
endif;
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'standard-pro' ),
		'cyrillic'     => __( 'Cyrillic', 'standard-pro' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'standard-pro' ),
		'devanagari'   => __( 'Devanagari', 'standard-pro' ),
		'greek'        => __( 'Greek', 'standard-pro' ),
		'greek-ext'    => __( 'Greek Extended', 'standard-pro' ),
		'khmer'        => __( 'Khmer', 'standard-pro' ),
		'latin'        => __( 'Latin', 'standard-pro' ),
		'latin-ext'    => __( 'Latin Extended', 'standard-pro' ),
		'vietnamese'   => __( 'Vietnamese', 'standard-pro' ),
	);
}
endif;
...
if ( ! function_exists( 'customizer_library_get_standard_pro_fonts' ) ) :
/**
 * Return an array of standard_pro websafe fonts.
 *
 * @since  1.0.0.
 *
 * @return array    standard_pro websafe fonts.
 */
function customizer_library_get_standard_pro_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'standard-pro' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'standard-pro' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'standard-pro' ),
...
function customizer_library_get_google_fonts() {
	return apply_filters( 'customizer_library_get_google_fonts', array(
		...
		'Old standard_pro TT' => array(
			'label'    => 'Old standard_pro TT',
			'variants' => array(
				'regular',
				'italic',
				'700',
