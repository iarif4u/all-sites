...
jQuery(document).ready(function () {
    ...
    /*
     *
     * Themonic_Options_upload function
    ...
    jQuery('.themonic-opts-upload').click(function () {
        header_clicked = true;
    ...
    jQuery('.themonic-opts-upload-remove').click(function () {
        $relid = jQuery(this).attr('rel-id');
        jQuery('#' + $relid).val('');
        jQuery(this).prev().fadeIn('slow');
        jQuery(this).prev().prev().fadeOut('slow', function () { jQuery(this).attr("src", themonic_upload.url); });
