...
/**
 * Options Sorter Field for Themonic Options
 ...
 */
class Themonic_Options_sorter extends Themonic_Options {
    ...
    function enqueue() {
        ...
        wp_register_script('options-sorter', Themonic_OPTIONS_URL . 'fields/sorter/sorter.js', array(
            'jquery'));
        wp_register_style('options-sorter', Themonic_OPTIONS_URL . 'fields/sorter/sorter.css');
