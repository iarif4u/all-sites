<?php
class Themonic_Options_text_sortable {
    ...
    */
    ...
    function enqueue() {
        wp_enqueue_script(
            'themonic-opts-field-social-links-js',
            Themonic_OPTIONS_URL . 'fields/text_sortable/field_text_sortable.js',
            array('jquery'),
            time(),
            true
        );
