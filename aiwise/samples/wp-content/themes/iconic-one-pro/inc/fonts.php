...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'publisho' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'publisho' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'vogue' ),
		'cyrillic'     => __( 'Cyrillic', 'vogue' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'vogue' ),
		'devanagari'   => __( 'Devanagari', 'vogue' ),
		'greek'        => __( 'Greek', 'vogue' ),
		'greek-ext'    => __( 'Greek Extended', 'vogue' ),
		'khmer'        => __( 'Khmer', 'vogue' ),
		'latin'        => __( 'Latin', 'vogue' ),
		'latin-ext'    => __( 'Latin Extended', 'vogue' ),
		'vietnamese'   => __( 'Vietnamese', 'vogue' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'vogue' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'vogue' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'vogue' ),
