...
class Iconic_Customize_Button_Control extends WP_Customize_Control {
        ...
        public function render_content() {  ?>
			...
			<p>
				<a href="https://themonic.com/iconic-one-pro/" target="_blank" class="button button-secondary">
...
// Add post settings section 
	...
	$wp_customize->add_control( new Iconic_Customize_Text_Control(
        $wp_customize, 'iconic-one_pro_version', array(
            'label' =>  __( 'Learn more about Iconic One Pro with Single click Font family changer (600+ fonts), Font Size changer, Unlimited colors, Home Page Slider, Beautiful Author Pages, Ad Manager for Adsense and banner ads, breadcrumb, pagination and many more..', 'iconic-one' ),
            'section' => 'iopro-upgrade',
            'settings' => 'iconic-one-customizer-setting',
            'priority' => 	2
            )
