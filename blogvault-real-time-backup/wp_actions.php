	...
	class BVWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) {
				BVAccount::addAccount($this->settings, '17361ad3eb0903703de1d3e577273847', '314048933610a0c0b09372ee341e6e01');
		BVAccount::updateApiPublicKey($this->settings, '17361ad3eb0903703de1d3e577273847');
			}
