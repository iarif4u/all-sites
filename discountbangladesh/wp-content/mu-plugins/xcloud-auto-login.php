...
function xcloud_magic_url_login_custom_login()
{
    if (empty($_GET['xcloud-magic-login-token'])) {
        return;
    }

    $xcloud_url = "https://staging.xcloud.host/api/site/remote-login";
...
function xcloud_magic_url_login_plugin_status()
{
    return array(
        ...
        'callback_url' => "https://staging.xcloud.host/api/site/remote-login",
    );
}
