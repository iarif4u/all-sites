<?php
    ...
    class post_grid_carousel extends \Elementor\Widget_Base {

        public function get_name() {
            return 'papermagpostgridslide';
        }

        public function get_title() {
            return esc_html__( 'Post Grid Slide', 'papermag-extension' );
        }
        ...
        ?>
        <div class="papermag-post-carousel-grid-wraper">
            
            <div class="papermag-post-carousel owl-carousel" <?php echo $this->get_render_attribute_string( 'papermag_postgridslide_options' ); ?>>
        ...
        <?php
            ...
            <?php
                ...
                while ( $query->have_posts() ) {
                    ...
                    <div class="post-grid-item-two papermag-common-hover">
