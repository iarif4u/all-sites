<?php
    ...
    class video_post_sports_tabs extends \Elementor\Widget_Base {

        public function get_name() {
            return 'video_post_sports_tab';
        }

        public function get_title() {
            return esc_html__( 'Post Video Sports Tab', 'papermag-extension' );
        }
        ...
        ?>
        <div class="papermag-post-spost-tap-area post-video-sports-tab">
        ...
        <ul class="papermag-tabs-sports nav nav-pills mb-3" id="pills-tab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <a   class="nav-link <?php if("yes" == $item['active_tab']){echo esc_attr('active');}?>" id="pmg-post-v-spot-<?php echo esc_attr($tabId);?>" data-toggle="pill" href="#pmg-post-v-spot-cont-<?php echo esc_attr($tabId);?>" type="button" role="tab" aria-controls="#pmg-post-v-spot-cont-<?php echo esc_attr($tabId);?>" aria-selected="true"><?php echo esc_html($item['tab_title']);?></a>
            </li>
            <?php endforeach;?>
        </ul>
        ...
        <div role="tabpanel" class="tab-pane fade <?php if("yes" == $item['active_tab']){echo esc_attr('show active');}?>" id="pmg-post-v-spot-cont-<?php echo esc_attr($tabId);?>" role="tabpanel" aria-labelledby="pmg-post-v-spot-<?php echo esc_attr($tabId);?>">
        <?php
            $args = array(
                'post_type'           => 'post',
        ...
        <div class="post-tabs-item-wrapp">
            <div class="row flex-row-reverse">
                ...
                ?>
                   ...
                   <div class="col-lg-8">
                   <div class="post-item-sport-tb-vd papermag-common-hover">
                        ...
                        <div class="post-grid-content">
                            ...
                            <h2 class="hover-title"><a href="<?php the_permalink()?>"><?php the_title();?></a></h2>
