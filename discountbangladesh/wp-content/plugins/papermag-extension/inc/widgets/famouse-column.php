<?php
    ...
    class exodus_famouse_column extends \Elementor\Widget_Base {

        public function get_name() {
            return 'exodus_famousecolumn';
        }

        public function get_title() {
            return esc_html__( 'Exodus Famouse Post', 'papermag-extension' );
        }
        ...
        protected function register_controls() {
            ...
            $this->add_responsive_control(
                'btm_space',
                [
                    'label'      => esc_html__( 'Bottom Space', 'papermag-extension' ),
                    ...
                    'selectors'  => [
                        '{{WRAPPER}} .famous-post-item' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector'  => '{{WRAPPER}} .famous-post-item h4',
                ]
            );
            $this->add_control(
                'title_color',
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .famous-post-item h4 a' => 'color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_control(
                ...
                [
                    'type'      => \Elementor\Controls_Manager::HEADING,
                    'label'     => esc_html__( 'Post Authore', 'papermag-extension' ),
                    'separator' => 'before',
                ]
            );
            $this->add_group_control(
                ...
                [
                    ...
                    'label'     => esc_html__( 'Typography', 'papermag-extension' ),
                    'selector'  => '{{WRAPPER}} .famous-post-item .auth-info-date span',
                ]
            );
            $this->add_control(
                'authore_color',
                [
                    ...
                    'type'      => \Elementor\Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}}  .famous-post-item .auth-info-date span' => 'color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_control(
                ...
                [
                    'type'      => \Elementor\Controls_Manager::HEADING,
                    'label'     => esc_html__( 'Post Date', 'papermag-extension' ),
                    'separator' => 'before',
                ]
            );
            $this->add_group_control(
                ...
                [
                    ...
                    'label'     => esc_html__( 'Typography', 'papermag-extension' ),
                    'selector'  => '{{WRAPPER}} .famous-post-item .papermag-post-date',
                ]
            );
            $this->add_control(
                'date_color_color',
                [
                    ...
                    'type'      => \Elementor\Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}}  .famous-post-item .papermag-post-date' => 'color: {{VALUE}}',
                    ],
                ]
            );
            $this->end_controls_section();
