<?php
    ...
    class exodus_post_list_sm extends \Elementor\Widget_Base {

        public function get_name() {
            return 'exoduspostlist-sm';
        }

        public function get_title() {
            return esc_html__( 'Exodus Post List Small', 'papermag-extension' );
        }
        ...
        <?php
            ...
            ?>                
                ...
                <div class="col-lg-3">
                    <div class="post-list-item-sm d-flex papermag-common-hover">
