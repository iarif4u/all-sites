<?php
    ...
    class exodus_post_list extends \Elementor\Widget_Base {

        public function get_name() {
            return 'exoduspostlist';
        }

        public function get_title() {
            return esc_html__( 'exodus Post List', 'papermag-extension' );
        }
...
<?php
        ...
        <?php
            ...
            ?>                
                ...
                <div class="post-list-item-one d-flex papermag-common-hover">
