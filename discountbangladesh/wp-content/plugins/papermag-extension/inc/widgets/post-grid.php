<?php
    ...
    class exodus_post_grid extends \Elementor\Widget_Base {

        public function get_name() {
            return 'exoduspostgrid';
        }

        public function get_title() {
            return esc_html__( 'exodus Post Grid', 'papermag-extension' );
        }
        ...
        <?php
            ...
            <div class="papermag-post__item papermag-common-hover">
                ...
                <div class="papermag-post-content">
                    ...
                    <h1 class="papermag-post-title hover-title">
